...
[Setup]
AppName=CVA Cointer
AppVerName=CVA Cointer 1.0.0.18
AppPublisher=CVA
AppPublisherURL=https://cvaconsultoria.com.br/
AppSupportURL=https://cvaconsultoria.com.br/
AppUpdatesURL=https://cvaconsultoria.com.br/
...
[Files]
;Bibliotecas
Source: ..\CVA.Cointer.AddOn\bin\Debug\CVA.Cointer.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.Cointer.AddOn\bin\Debug\CVA.Cointer.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Cointer.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Cointer.AddOn\bin\Debug\Views\*.srf; DestDir: {app}\Views; Flags: ignoreversion
Source: ..\CVA.Cointer.AddOn\bin\Debug\Menu\Menu.xml; DestDir: {app}\Menu; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'CvaCointerMMH';
  PARTNER_ID = 'CVA';
