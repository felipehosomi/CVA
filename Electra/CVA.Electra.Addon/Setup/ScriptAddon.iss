...
[Setup]
AppName=Electra.Addon
AppVerName=Electra.Addon 1.0.0.0
...
Uninstallable=yes
OutputBaseFilename=Electra.Addon_V1.0.0.0

[Files]
;API DO SAP B1
Source: ..\CVA.Electra.AddOn\bin\Debug\CVA.Electra.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.Electra.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Electra.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: "C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll"; Flags: dontcopy;


;Información para la desinstalación
[Registry]
Root: HKCU; Subkey: "Software\CVA\Electra.Addon"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\CVA\Electra.Addon\Management"; Flags: uninsdeletekey
Root: HKLM; Subkey: "Software\CVA\Electra.Addon"; Flags: uninsdeletekeyifempty
Root: HKLM; Subkey: "Software\CVA\Electra.Addon\Management"; Flags: uninsdeletekey
Root: HKLM; Subkey: "Software\CVA\Electra.Addon\Management"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"
...
function CheckInstalled(): boolean;
  ...
  begin
    result := False;
    //-if find...
     if RegQueryStringValue(HKLM, 'Software\CVA\Electra.Addon\Management','InstallPath', CurrentLocation) then
      begin
