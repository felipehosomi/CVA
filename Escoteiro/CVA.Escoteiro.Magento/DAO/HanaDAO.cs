...
namespace CVA.Escoteiro.Magento.DAO
{
    public class HanaDAO : IDAO
    {
        ...
        public string GetNextCode(string tableName, string database)
        {
            return GetNextCode(tableName, "Code", String.Empty, database);
        }
        ...
        /// <returns>Código</returns>
        public string GetNextCode(string tableName, string fieldName, string database)
        {
            return GetNextCode(tableName, fieldName, String.Empty, database);
        }
        ...
        /// <returns>Código</returns>
        public string GetNextCode(string tableName, string fieldName, string where, string database)
        {
        ...
        /// </summary>
        public void CreateModel(string dataBase)
        {
            try
            {
                ...
                if (propCode != null)
                {
                    ...
                    {
                        propCode.SetValue(Model, GetNextCode(TableName, dataBase).PadLeft(8, '0'));
                    }
                }
        ...
        #region UpdateModel
        public void UpdateModel(string database)
        {
            try
            {
                ModelControllerAttribute modelController;
        ...
        public void DeleteModel(string dataBase)
        {
        ...
        public bool Exists(string where, string dataBase)
        {
        ...
        public T RetrieveModel<T>(string where = "", string orderBy = "", string database = "")
        {
            List<T> modelList = this.RetrieveModelList<T>(where, orderBy, database);
            if (modelList.Count > 0)
                return modelList[0];
            else
                return Activator.CreateInstance<T>();
        ...
        public List<T> RetrieveModelList<T>(string where = "", string orderBy = "", string dataBase="")
        {
