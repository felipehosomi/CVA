    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Application.SBO_Application.StatusBar.SetText("Conexão do add-on: CVA.Escoteiros.Magento.AddOn", BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Success);
