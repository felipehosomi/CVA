...
namespace CVA.Escoteiros.CriadorDeCampos.BLL
{
    public class UserFieldsBLL
    {
        public static void CreateUserFields()
        {
            ...
            userObjectController.InsertUserField("ORDR", "CVA_Separacao_Impresso", "Separação Impressa", BoFieldTypes.db_Alpha, BoFldSubTypes.st_None, 1);
            userObjectController.AddValidValueToUserField("ORDR", "CVA_Separacao_Impresso", "1", "Impresso");
            userObjectController.AddValidValueToUserField("ORDR", "CVA_Separacao_Impresso", "2", "Não Impresso", true);

            //userObjectController.InsertUserField("ORDR", "CVA_Separacao_Impresso", "Separação Impressa", BoFieldTypes.db_Alpha, BoFldSubTypes.st_None, 1);
            //userObjectController.AddValidValueToUserField("ORDR", "CVA_Separacao_Impresso", "1", "Sim");
            //userObjectController.AddValidValueToUserField("ORDR", "CVA_Separacao_Impresso", "2", "Não", true);


            userObjectController.InsertUserField("ORDR", "OrigemPedido", "Origem Pedido", BoFieldTypes.db_Alpha, BoFldSubTypes.st_None, 1);
            userObjectController.AddValidValueToUserField("ORDR", "OrigemPedido", "1", "Pedido - E-Commerce");
            userObjectController.AddValidValueToUserField("ORDR", "OrigemPedido", "2", "Pedido - Interno", true);
            userObjectController.AddValidValueToUserField("ORDR", "OrigemPedido", "3", "Pedido - Distribuidor");
            ...
            userObjectController.InsertUserField("@CVA_TpVol", "CVA_Peso", "Peso", BoFieldTypes.db_Numeric, BoFldSubTypes.st_None, 11);
            userObjectController.InsertUserField("@CVA_TpVol", "CVA_Largura", "Largura", BoFieldTypes.db_Numeric, BoFldSubTypes.st_None, 11);
            userObjectController.InsertUserField("@CVA_TpVol", "CVA_Altura", "Altura", BoFieldTypes.db_Numeric, BoFldSubTypes.st_None, 11);
            userObjectController.InsertUserField("@CVA_TpVol", "CVA_Comprimento", "Comprimento", BoFieldTypes.db_Numeric, BoFldSubTypes.st_None, 11);
            ...
            #region [CVA] Gerencimaento de estoque Magento        

            userObjectController.CreateUserTable("CVA_STOCK_MAGENTO", "[CVA] Estoque Magento", BoUTBTableType.bott_NoObjectAutoIncrement);
            userObjectController.InsertUserField("@CVA_STOCK_MAGENTO", "BarCode", "Cód. Barras", BoFieldTypes.db_Alpha, BoFldSubTypes.st_None, 254);
            userObjectController.InsertUserField("@CVA_STOCK_MAGENTO", "ItemCode", "Cód. Item", BoFieldTypes.db_Alpha, BoFldSubTypes.st_None, 50);
            userObjectController.InsertUserField("@CVA_STOCK_MAGENTO", "ItemName", "Descrição do item", BoFieldTypes.db_Alpha, BoFldSubTypes.st_None, 100);
            userObjectController.InsertUserField("@CVA_STOCK_MAGENTO", "WhsQty", "Quantidade em estoque", BoFieldTypes.db_Float, BoFldSubTypes.st_Quantity, 0);
            userObjectController.InsertUserField("@CVA_STOCK_MAGENTO", "LastSyncDt", "Data da última sincronização", BoFieldTypes.db_Date, BoFldSubTypes.st_None, 0);
            userObjectController.InsertUserField("@CVA_STOCK_MAGENTO", "LastSyncHr", "Hora da última sincronização", BoFieldTypes.db_Date, BoFldSubTypes.st_Time, 0);
            #endregion
