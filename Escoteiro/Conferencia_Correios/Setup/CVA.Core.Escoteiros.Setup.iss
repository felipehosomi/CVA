...
#define MyAppName "CVA.Core.Escoteiros.AddOn"
#define MyAppVersion "1.0.0.1"
#define MyAppPublisher "CVA"
#define MyAppURL "http://www.cvaconsultoria.com.br"
#define MyAppExeName "CVA.Core.Escoteiros.AddOn.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{D04C2320-45D3-4A0E-ADAA-1F0FF835409D}}
AppName={#MyAppName}
...
Source: "..\CVA.Core.Escoteiros.Addon\bin\Debug\*"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.Core.Escoteiros.Addon\bin\Debug\Menu\*"; DestDir: "{app}\srfFiles"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\CVA.Core.Escoteiros.Addon\bin\Debug\Reports\*"; DestDir: "{app}\srfFiles"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\CVA.Core.Escoteiros.Addon\bin\Debug\srfFiles\*"; DestDir: "{app}\srfFiles"; Flags: ignoreversion recursesubdirs createallsubdirs
