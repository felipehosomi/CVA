    ...
    public class CollaboratorDAO 
    {
        ...
        public List<CollaboratorModel> GetFromSpecialty(SpecialtyModel specialty)
        {
            try
            {
                ...
                {
                    conn.CreateDataAdapter(StoredProcedure.Collaborator_GetSpecialty);
                    conn.InsertParameter("FUNC", specialty.Id);
                    return conn.GetResult().ToListData<CollaboratorModel>();
                }
            }
            catch (Exception)
        ...
        public int SpecialtyCollaborator_Update(CollaboratorModel collaborator, SpecialtyModel specialty)
        {
            try
            {
                using (Connection conn = new Connection())
                {
                    ...
                    conn.InsertParameter("COL", collaborator.Id);
                    conn.InsertParameter("FUNC", specialty.Id);
        ...
        public DataTable Get_ProjectResources(int id)
        {
            try
            {
                using (Connection conn = new Connection())
                {
                    conn.CreateDataAdapter(StoredProcedure.Collaborator_Get_ProjectResources);
