...
namespace CVAGestaoLayout.Controllers
{
    ...
    public class OportunidadeController : Controller
    {
        ...
        {
            var retorno = _oportunittyClient.GetOpportunities();
            return View(retorno);
        }

        public string NewCodeGenerator()
        {
            return _oportunittyClient.NewCodeGenerator();
        }
        ...
        {
            return JsonConvert.SerializeObject(_oportunittyClient.Oportunitty_GetSteps());
        }
