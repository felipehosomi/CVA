...
namespace CVAGestaoLayout
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Business/Project").Include("~/Scripts/ScriptPage/ProjectController.js"));
            bundles.Add(new ScriptBundle("~/Business/ProjectMain").Include("~/Scripts/ScriptPage/ProjectMainController.js"));
            bundles.Add(new ScriptBundle("~/Business/Specialty").Include("~/Scripts/ScriptPage/SpecialtyController.js"));
            bundles.Add(new ScriptBundle("~/Business/Collaborator").Include("~/Scripts/ScriptPage/CollaboratorController.js"));
            bundles.Add(new ScriptBundle("~/Business/CollaboratorMain").Include("~/Scripts/ScriptPage/CollaboratorMainController.js"));
            ...
            bundles.Add(new ScriptBundle("~/Business/ProjectResourcesController").Include("~/Scripts/ScriptPage/ProjectResourcesController.js"));
