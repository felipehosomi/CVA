cvaGestao.controller('Project6Controller', ['$scope', '$http', function ($scope, $http) {
    $scope.ProjectList = [];
    ...
    $scope.ProjectSelected = function () {
        if ($scope.collaborators.Id == null || $scope.collaborators.project.Id == '' || $scope.collaborators.Id == undefined) {
            if ($scope.project.Id == null || $scope.project.Id == '' || $scope.project.Id == undefined) {
                $http({
                    method: 'GET',
                    url: '/RecursosProjeto/GetColaboradores?projectId=0'
    ...
    $scope.Save = function () {
        if ($scope.ResourcesList.length == 0)
            return;
