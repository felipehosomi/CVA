...
namespace CVAGestaoService
{
    public class CVAGestaoService : ILogin, ICalendar, IStatus, IUser, IProject, ISpecialty, ICollaborator, IGenre,
                                    IMaritalStatus, IUf, IClient, IExpense, IProjectStep, IOpportunity, INote, INotePeriod,
                                    IExpenseType, IPoliticExpense, IUnitMeter, IProfile, IUserView, IPeriod,
                                    IAMSTicket, IEmailSender, IProjectType, IPricing, IPercentProject,
                                    IProjectParameters, IStatusReport, IChangeRequest, IAuthorization
    {
        ...
        private NotePeriodContract _notePeriodContract { get; set; }
        ...
        public CVAGestaoService()
        {
            ...
            this._notePeriodContract = new NotePeriodContract();
        ...
        {
            return _projectContract.Project_Add_ColToProject(ProjectId, ColaboradorId);
        }
        ...
        {
            return _projectContract.Project_Remove_ColToProject(ProjectId, ColaboradorId);
        }
        ...
        public List<ProjectModel> Project_Search(ProjectFilterModel model)
        {
            return _projectContract.Filter_Projects(model);
        }
        ...
        {
            return _specialtyContract.Get_Specialty(projectId, StepId, user);
        }
        ...
        {
            return _projectStepContract.Get_ProjectSteps(id, user);
        }
        ...
        {
            return _oportunittyContract.Generate_NewCode(id);
        }
        ...
        #region Note Methods
        public MessageModel Note_Save(NoteModel note)
        {
            return _noteContract.Save(note);
        }

        public MessageModel Note_Remove(NoteModel model)
        {
            return _noteContract.Remove(model);
        }

        public List<NoteModel> Get_UserNotes(int id, int mes, int ano)
        {
            return _noteContract.Get_UserNotes(id, mes, ano);
        }

        public List<NoteModel> Note_Search(NoteFilterModel model)
        {
            return _noteContract.Search(model);
        }
        #endregion
        ...
        {
            return _notePeriodContract.GetAllPeriods();
        }

        public NotePeriod GetPeriod(int year, int month)
        {
            return _notePeriodContract.GetPeriod(year, month);
        }

        public void AddPeriod(int year, int month)
        {
            _notePeriodContract.AddPeriod(year, month);
        }

        public void DeletePeriod(int year, int month)
        {
            _notePeriodContract.DeletePeriod(year, month);
        }
        #endregion
        ...
        public List<ExpenseModel> GetExpense_ByUserID(int userId, int mes, int ano)
        {
            return _expenseContract.GetExpense_ByUserID(userId, mes, ano);
        }
        ...
        {
            return _authorizationContract.Get_DespesasAutorizados(idCol);
        }

        public MessageModel AddDespesaAutorizado(AuthorizedDayModel model)
        {
            return _authorizationContract.AddDespesaAutorizado(model);
        }

        public MessageModel RemoveDespesaAutorizado(int id)
        {
            return _authorizationContract.RemoveDespesaAutorizado(id);
        }
        ...
        {
            return _AMSTicketContract.GetTicketsByProjectAndDate(clientId, date);
        }

        public List<AMSTicketModel> GetTicketsByProjectAndDateAndTicket(int clientId, DateTime date, int numTicket)
        {
            return _AMSTicketContract.GetTicketsByProjectAndDateAndTicket(clientId, date, numTicket);
        }
        #endregion
