...
namespace CVAGestaoService.Contracts
{
    ...
    public class ProjectContract
    {
        ...
        public List<ProjectModel> Filter_Projects(ProjectFilterModel model)
        {
            return _projectBLL.Search(model);
        }
        ...
        {
            return null;// _projectBLL.Generate_Number(id);
        }
        ...
        {
            return null;// _projectBLL.Get_StatusReportParcial(id);
        }
        ...
        {
            return null;// _projectBLL.Project_Add_ColToProject(ProjectId, ColaboradorId);
        }

        public MessageModel Project_Remove_ColToProject(int ProjectId, int ColaboradorId)
        {
            return null;//_projectBLL.Project_Remove_ColToProject(ProjectId, ColaboradorId);
        }
