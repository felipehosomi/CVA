...
namespace CVAGestaoService.Contracts
{
    ...
    public class AuthorizationContract
    {
        ...
        {
            return _authorizationBLL.Get_DespesasAutorizados(idCol);
        }

        public MessageModel AddDespesaAutorizado(AuthorizedDayModel model)
        {
            return _authorizationBLL.AddDespesaAutorizado(model);
        }

        public MessageModel RemoveDespesaAutorizado(int id)
        {
            return _authorizationBLL.RemoveDespesaAutorizado(id);
        }
