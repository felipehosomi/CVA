...
namespace CVAGestaoService.Services
{
    ...
    public interface IAuthorization
    {
        ...
        [OperationContract]
        List<AuthorizedDayModel> Get_DespesasAutorizados(int idCol);

        [OperationContract]
        MessageModel AddDespesaAutorizado(AuthorizedDayModel model);

        [OperationContract]
        MessageModel RemoveDespesaAutorizado(int id);
