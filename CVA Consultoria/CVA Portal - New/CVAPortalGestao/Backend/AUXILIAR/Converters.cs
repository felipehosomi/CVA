...
namespace AUXILIAR
{
    ...
    {
        public static int Success(this DataTable table)
        {
            try
            {
                return GetDataSuccess(table, "SUCCESS");
        ...
        public static int SuccessId(this DataTable table)
        {
            try
            {
                return GetDataSuccess(table, "SUCCESSID");
            }
            catch (Exception)
            {
                throw;
        ...
        private static int GetDataSuccess(DataTable table, string successType)
        {
            int result = 0;
            Int32.TryParse(table.Rows[0][successType].ToString(), out result);
            return result;
        }

        public static List<T> ToListData<T>(this DataTable table) where T : class, new()
        {
            try
            {
