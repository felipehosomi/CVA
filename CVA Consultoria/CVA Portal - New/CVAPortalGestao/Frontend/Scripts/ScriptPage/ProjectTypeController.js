cvaGestao.controller('ProjectTypeController', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    ...
    function ValidateModel() {
        ...
        if ($scope.TipoProjeto.ControleHoras == undefined || $scope.TipoProjeto.ControleHoras == null || $scope.TipoProjeto.ControleHoras == '') {
            noty({ text: 'Obrigatório informar o campo "Controle de Horas"', layout: 'topRight', type: 'error' });
            return false;
        }
        return true;
    }
