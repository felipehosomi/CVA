...
namespace CVAGestaoLayout.Controllers
{
    public class DespesaController : Controller
    {
        ...
        {
            return View(_expenseClient.GetExpense_ByUserID(GetSession.UserConnected.Id, DateTime.Today.Month, DateTime.Today.Year));
        }
        ...
        {
            return JsonConvert.SerializeObject(_expenseClient.GetExpense_ByUserID(GetSession.UserConnected.Id, month, year));
        }
        ...
        public string Save()
        {
            ...
            if (httpRequest.Files.Count > 0)
            {
                ...
                UserModel userModel = this._userClient.GetUser(expense.USR);
            ...
            expense.User = new UserModel
            {
                ...
                Name = this._userClient.GetUser(expense.USR).Name
            };
