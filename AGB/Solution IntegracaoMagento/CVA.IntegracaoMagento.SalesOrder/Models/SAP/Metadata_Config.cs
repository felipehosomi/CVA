...
namespace CVA.IntegracaoMagento.SalesOrder.Models.SAP
{
    public class Metadata_Config
    {
        public class CVA_CONFIG_MAG
        {
            ...
            public IList<CVACONFIGMAG4Collection> CVA_CONFIG_MAG4Collection { get; set; }
            public IList<CVACONFIGMAG5Collection> CVA_CONFIG_MAG5Collection { get; set; }
        }
        ...
        public class CVACONFIGMAG4Collection
        {
            public string Code { get; set; }
            public int LineId { get; set; }
            public string Object { get; set; }
            public object LogInst { get; set; }
            public DateTime U_DataDe { get; set; }
            public DateTime U_DataAte { get; set; }
            public DateTime U_DataVenc { get; set; }
        }

        public class CVACONFIGMAG5Collection
        {
            public string Code { get; set; }
            public int LineId { get; set; }
            public string Object { get; set; }
            public object LogInst { get; set; }
            public string U_TipoPV { get; set; }
            public string U_FreteSap { get; set; }
            public string U_FreteMagento { get; set; }
        }
