...
namespace CVA.IntegracaoMagento.SalesOrder.Models.Magento
{
    ...
    {        
        ...
        public class Item2
        {
            ...
            public double qty_refunded { get; set; }
        ...
        public class ExtensionAttributes
        {
            ...
            public IList<PaymentAdditionalInfo> payment_additional_info { get; set; }
            public IList<object> applied_taxes { get; set; }
            public IList<object> item_applied_taxes { get; set; }
        }
        ...
        public class Item
        {
            ...
            public string is_pos_order { get; set; }
            public IList<Item2> items { get; set; }
            public BillingAddress billing_address { get; set; }
            public Payment payment { get; set; }
            public IList<object> status_histories { get; set; }
