IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'SP_CVA_RESTGO')
	DROP PROCEDURE SP_CVA_RESTGO
GO
CREATE PROCEDURE SP_CVA_RESTGO
(
	@Branch		INT,
	@DateFrom	DATETIME,
	@DateTo		DATETIME
...
BEGIN
	SELECT
		CRD7.TaxId3		[Insc. Municipal],
		OCRD.CardName	[Nome],
		CRD7.TaxId0		[CNPJ/CPF],
		OPCH.Serial		[Nº NF],
		OPCH.DocDate	[Data Emissão],
		OPCH.DocDueDate	[Data Pagamento],
		CRD1.State		[UF],
		CRD1.City		[Cidade],
