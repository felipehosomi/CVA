IF EXISTS (SELECT * FROM sys.objects WHERE type = 'IF' AND name = 'FN_CVA_SEF_E310')
	DROP FUNCTION FN_CVA_SEF_E310
GO
CREATE FUNCTION FN_CVA_SEF_E310
(
	@Filial			INT,
...
(
	...
	(
		...
		AND ISNULL(RDN1.TargetType, 0) <> 18
		...
		AND ISNULL(RIN1.TargetType, 0) <> 18
