IF EXISTS (SELECT * FROM sys.objects WHERE type = 'IF' AND name = 'FN_CVA_SEF_E525')
	DROP FUNCTION FN_CVA_SEF_E525
GO
CREATE FUNCTION FN_CVA_SEF_E525
(
	@Filial			INT,
...
(
	...
	(
		...
		GROUP BY SUBSTRING(PDN1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(PCH1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(RDN1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(RIN1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(DLN1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(INV1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(RPD1.CFOPCode, 1, 1)
		...
		GROUP BY SUBSTRING(RPC1.CFOPCode, 1, 1)
	)
	, Grouped AS
	(
		SELECT
