...
[Setup]
AppName=CVA - Obrigações Fiscais
AppVerName=CVA - Obrigações Fiscais 2.0.0.7
...
[Files]
;Bibliotecas
Source: ..\CVA.Core.ObrigacoesFiscais.AddOn\bin\Debug\CVA.Core.ObrigacoesFiscais.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.Core.ObrigacoesFiscais.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Core.ObrigacoesFiscais.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Core.ObrigacoesFiscais.AddOn\bin\Debug\DAO\Sproc\*.sql; DestDir: {app}\DAO\Sproc; Flags: ignoreversion
Source: ..\CVA.Core.ObrigacoesFiscais.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: ..\CVA.Core.ObrigacoesFiscais.AddOn\bin\Debug\Reports\*.rpt; DestDir: {app}\Reports; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPCoreAlessi';
  PARTNER_ID = 'CVA';
