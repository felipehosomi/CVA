...
[Setup]
AppName=SAP AddOn Alessi
AppVerName=SAP AddOn Alessi 2.0.0.18
...
[Files]
;Bibliotecas
Source: ..\CVA.Core.Alessi.AddOn\bin\Debug\CVA.Core.Alessi.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.Core.Alessi.AddOn\bin\Debug\CVA.Core.Alessi.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Core.Alessi.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Core.Alessi.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.Core.Alessi.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'CVACoreAlessi';
  PARTNER_ID = 'CVA';
