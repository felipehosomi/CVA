...
/****** Object:  StoredProcedure [dbo].[scp_CVA_ResFiTotalAnalitico]    Script Date: 04/09/2018 11:24:23 ******/
DROP PROCEDURE [dbo].[scp_CVA_ResFiTotalAnalitico]
GO
...
GO 
Create proc scp_CVA_ResFiTotalAnalitico 
  @CardCode varchar(20)  
as  
...
drop table #tmp  
  ...
  go
exec  scp_CVA_ResFiTotalAnalitico 'C40000'