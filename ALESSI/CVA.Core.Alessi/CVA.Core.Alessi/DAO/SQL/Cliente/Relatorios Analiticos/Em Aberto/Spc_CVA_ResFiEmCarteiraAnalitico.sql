...
DROP PROCEDURE [dbo].[scp_CVA_ResFiEmCarteiraAnalitico]
GO
...
GO 
Create proc scp_CVA_ResFiEmCarteiraAnalitico 
  @CardCode varchar(20)  
as  
...
select CardCode +' - ' + CardName as 'Cliente'
  ...
  from #tmp  
  #tmp where PayMethodNF in('RecebTransf','')
drop table #tmp  
end  
  
  go
exec  scp_CVA_ResFiEmCarteiraAnalitico 'C40000'