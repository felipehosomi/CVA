...
/****** Object:  StoredProcedure [dbo].[scp_CVA_ResFiBoletoAnalitico]    Script Date: 04/09/2018 11:24:23 ******/
DROP PROCEDURE [dbo].[scp_CVA_ResFiBoletoAnalitico]
GO

/****** Object:  StoredProcedure [dbo].[scp_CVA_ResFiEmCarteiraAnalitico]    Script Date: 04/09/2018 11:24:23 ******/
SET ANSI_NULLS ON
GO

SET QUOTED_IDENTIFIER ON
GO 
Create proc scp_CVA_ResFiBoletoAnalitico 
  @CardCode varchar(20)  
as  
...
select CardCode +' - ' + CardName as 'Cliente'
  ...
  from #tmp  
  #tmp where FormaPagamento like 'Bol%'
drop table #tmp  
end  
  
  go
exec  scp_CVA_ResFiBoletoAnalitico 'C40000'