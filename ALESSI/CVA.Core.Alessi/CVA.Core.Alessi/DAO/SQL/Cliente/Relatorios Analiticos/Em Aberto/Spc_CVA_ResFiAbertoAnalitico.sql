...
/****** Object:  StoredProcedure [dbo].[scp_CVA_ResFiAbertoAnalitico]    Script Date: 04/09/2018 11:24:23 ******/
DROP PROCEDURE [dbo].[scp_CVA_ResFiAbertoAnalitico]
GO
...
GO 
Create proc scp_CVA_ResFiAbertoAnalitico  
  @CardCode varchar(20)  
as  
...
select CardCode +' - ' + CardName as 'Cliente'
  ...
  from #tmp    
  where  #tmp.DueDate <= #tmp.RefDate
drop table #tmp  
end    

go
exec  scp_CVA_ResFiAbertoAnalitico 'C40000'