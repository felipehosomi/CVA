...
/****** Object:  StoredProcedure [dbo].[scp_CVA_ResFiAtrasadosAnaliticoGrupo]    Script Date: 04/09/2018 11:24:23 ******/
DROP PROCEDURE [dbo].[scp_CVA_ResFiAtrasadosAnaliticoGrupo]
GO
...
GO 
Create proc scp_CVA_ResFiAtrasadosAnaliticoGrupo 
  @grupo varchar(20)  
as  
...
select CardCode +' - ' + CardName as 'Cliente'
  ...
  from #tmp  
  #tmp where #tmp.DueDate < @dt
drop table #tmp  
end  
  
  go
exec  scp_CVA_ResFiAtrasadosAnaliticoGrupo '002'