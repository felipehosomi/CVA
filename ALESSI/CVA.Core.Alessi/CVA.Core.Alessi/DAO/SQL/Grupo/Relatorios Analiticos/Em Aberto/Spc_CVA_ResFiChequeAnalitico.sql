...
/****** Object:  StoredProcedure [dbo].[scp_CVA_ResFiChequeAnaliticoGrupo]    Script Date: 04/09/2018 11:24:23 ******/
DROP PROCEDURE [dbo].[scp_CVA_ResFiChequeAnaliticoGrupo]
GO
...
GO 
Create proc scp_CVA_ResFiChequeAnaliticoGrupo 
  @grupo varchar(20)  
as  
...
select CardCode +' - ' + CardName as 'Cliente'
  ...
  from #tmp  
  #tmp where FormaPagamento like '%Cheque%'
  order by 1
drop table #tmp  
end  
  
  go
exec  scp_CVA_ResFiChequeAnaliticoGrupo '002'