...
namespace CVA.View.ImportadorFolha.VIEW
{
    ...
    /// Tela Importação
    /// </summary>
    public class f2000006061 : BaseForm
    {
        #region Constructor
        public f2000006061()
        {
        ...
        public f2000006061(SAPbouiCOM.ItemEvent itemEvent)
        {
            this.ItemEventInfo = itemEvent;
        }

        public f2000006061(SAPbouiCOM.BusinessObjectInfo businessObjectInfo)
        {
            this.BusinessObjectInfo = businessObjectInfo;
        }

        public f2000006061(SAPbouiCOM.ContextMenuInfo contextMenuInfo)
        {
