...
[Setup]
AppName=SAP AddOn Importador Folha Pagamento
AppVerName=SAP AddOn Importador Folha Pagamento 1.0.0.3
...
[Files]
;Bibliotecas
Source: ..\CVA.View.ImportadorFolha.AddOn\bin\Debug\CVA.View.ImportadorFolha.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.ImportadorFolha.AddOn\bin\Debug\CVA.View.ImportadorFolha.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.ImportadorFolha.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.ImportadorFolha.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.ImportadorFolha.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPViewFolha';
  PARTNER_ID = 'CVA';
