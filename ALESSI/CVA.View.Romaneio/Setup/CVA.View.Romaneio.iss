...
[Setup]
AppName=SAP AddOn Romaneio
AppVerName=SAP AddOn Romaneio 1.0.0.5
...
[Files]
;Bibliotecas
Source: ..\CVA.View.Romaneio.AddOn\bin\Debug\CVA.View.Romaneio.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.Romaneio.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.Romaneio.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.Romaneio.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: ..\CVA.View.Romaneio.AddOn\bin\Debug\Reports\*.rpt; DestDir: {app}\Reports; Flags: ignoreversion
