...
/****** Object:  StoredProcedure [dbo].[spcNMSFluxoCaixa_CARGA]    Script Date: 06/09/2015 09:17:57 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNMSFluxoCaixa_CARGA]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNMSFluxoCaixa_CARGA]
GO
...
-- exec spcNMSFluxoCaixa_CARGA '01-01-2050' 

CREATE proc [dbo].[spcNMSFluxoCaixa_CARGA]
  @dt smalldatetime 
as
...
--execute [spcNMSContasAReceberPorVencimento] '*','2010-01-01 00:00:00','2020-01-01 00:00:00','V','*'
...
--execute spcNMSContasAPagarPorVencimento '*','2010-01-01 00:00:00','2020-01-01 00:00:00','V'
