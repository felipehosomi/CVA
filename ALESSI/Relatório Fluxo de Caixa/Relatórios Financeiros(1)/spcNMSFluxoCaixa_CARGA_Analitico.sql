...
/****** Object:  StoredProcedure [dbo].[spcNMSFluxoCaixa_CARGA_Analitico]    Script Date: 06/09/2015 09:18:03 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNMSFluxoCaixa_CARGA_Analitico]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNMSFluxoCaixa_CARGA_Analitico]
GO
...
-- exec spcNMSFluxoCaixa_CARGA_Analitico '2050-01-01', 'S', 'N'
CREATE proc [dbo].[spcNMSFluxoCaixa_CARGA_Analitico]
  @dt smalldatetime 
, @caixa char(1)
, @atrasos char(1)
with encryption
...
-- execute spcNMSContasAPagarPorVencimento '*','01-01-2000 00:00:00','01-01-2050 00:00:00','V'
...
-- execute [spcNMSContasAReceberPorVencimento] '*','01-01-2000 00:00:00','01-01-2050 00:00:00','V','*'

insert  into #ContasAReceberPorVencimento
EXECUTE [spcNMSContasAReceberPorVencimento] 
   '*'
  ,'1900-11-20'
  --,'2050-11-20'
  --,'1900-11-16'
  ...
  insert into #lancamentos (tipo, docnum, cardcode, cardname, dt_vencimento, valor)
    ...
    FROM (
     ...
     --  ojdt.TransId as DocNum, 
		   ...
		   -- dbo.funcNMSNomeObjeto(OJDT.ObjType) as tp_doc_Nome,
		   -- 1										AS nr_parcela,
		   ...
		   -- dbo.funcNMSNomeObjeto(JDT1.TransType) as tp_origem_Nome,
		   -- NULL									AS nr_nota,
		   -- NULL									AS cd_vendedor,
	    ...
	    --'OBOE' as tipo,
		   ...
		   -- dbo.funcNMSNomeObjeto(OVPM.ObjType) as tp_doc_Nome,
  ...
  --     and jdt1.TransType = 30
	 ...
	 --   'OBOE' as tipo,
		...
		--    dbo.funcNMSNomeObjeto(ORCT.ObjType) as tp_doc_Nome,
