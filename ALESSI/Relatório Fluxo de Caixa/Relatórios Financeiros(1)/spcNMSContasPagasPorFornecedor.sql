...
/****** Object:  StoredProcedure [dbo].[spcNMSContasPagasPorFornecedor]    Script Date: 06/09/2015 09:17:35 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNMSContasPagasPorFornecedor]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNMSContasPagasPorFornecedor]
GO
...
CREATE PROC [dbo].[spcNMSContasPagasPorFornecedor] (
	@CarCode nvarchar(15),
	@dataIni date,
	@dataFim date,
	@tpdata  varchar(2)
