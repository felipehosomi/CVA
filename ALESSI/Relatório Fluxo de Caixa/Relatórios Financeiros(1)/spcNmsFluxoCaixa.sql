...
/****** Object:  StoredProcedure [dbo].[spcNmsFluxoCaixa]    Script Date: 06/09/2015 09:17:52 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNmsFluxoCaixa]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNmsFluxoCaixa]
GO
...
-- exec spcNMSFluxoCaixa '01-01-2050' 
CREATE proc [dbo].[spcNmsFluxoCaixa]  
  @dt smalldatetime  
, @atrasados char(1) = 'N'  
, @caixa char(1)     = 'N'  
, @grafico char(1)   = 'S'  
...
SET DATEFORMAT 'ymd';  
  ...
  exec spcNMSFluxoCaixa_CARGA @dt  
