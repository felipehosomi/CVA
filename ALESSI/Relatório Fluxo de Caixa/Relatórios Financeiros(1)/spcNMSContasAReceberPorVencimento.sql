...
/****** Object:  StoredProcedure [dbo].[spcNMSContasAReceberPorVencimento]    Script Date: 06/09/2015 09:17:23 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNMSContasAReceberPorVencimento]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNMSContasAReceberPorVencimento]
GO
...
--select  'V' 'Tipo','Dt. Vencimento' 'Desc' union all select  'LC','Dt. Lançamento'
 --Select 'B' 'Tipo', 'Boleto' 'desc' union all select 'T', 'Transfencia' 'desc' union all select 'C','Cheque' 'desc' union all select 'CC','Cartão de Crédito' 'desc' union all select 'D','Dinheiro'
--execute spcNMSContasAReceberPorVencimento '*','2010-01-01 00:00:00','2020-01-01 00:00:00','V','*'
--execute [spcNMSContasAReceberPorVencimento] '*','2010-01-01 00:00:00','2020-01-01 00:00:00','2010-01-01 00:00:00','2020-01-01 00:00:00'
CREATE PROC [dbo].[spcNMSContasAReceberPorVencimento] (
	@CardCode varchar(15),
	@dateini date,
	@datefim date,
	@tpData varchar(2)
