...
/****** Object:  StoredProcedure [dbo].[spcNMSContasAPagarPorVencimento]    Script Date: 06/09/2015 09:17:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNMSContasAPagarPorVencimento]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNMSContasAPagarPorVencimento]
GO
...
CREATE PROC [dbo].[spcNMSContasAPagarPorVencimento] (
	@CarCode nvarchar(15),
	@dateini date,
	@datefim date,
	@tpdata  varchar(2)
