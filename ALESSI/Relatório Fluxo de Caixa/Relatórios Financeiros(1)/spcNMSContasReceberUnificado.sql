...
/****** Object:  StoredProcedure [dbo].[spcNMSContasReceberUnificado]    Script Date: 06/09/2015 09:17:39 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spcNMSContasReceberUnificado]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spcNMSContasReceberUnificado]
GO
...
CREATE PROC [dbo].[spcNMSContasReceberUnificado] (
	@cardcode varchar(30),	
	@dateini  date,
	@datefim  date,
	@tpData   varchar(2)
...
begin
--go
--execute [spcNMSContasReceberUnificado] '*','2010-01-01 00:00:00','2020-01-01 00:00:00','V'
...
EXECUTE [spcNMSContasRecebidasPorCliente] 
	@cardcode,
	@dateini,@datefim,@tpData
	----0,
	--@duedateini,
