IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'spc_CVA_ContasPagasPorFornecedor')
	DROP PROCEDURE spc_CVA_ContasPagasPorFornecedor
GO
CREATE PROC [dbo].spc_CVA_ContasPagasPorFornecedor (
	@CarCode nvarchar(15),
	@dataIni date,
	@dataFim date,
	@tpdata  varchar(2)
