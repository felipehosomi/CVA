...
/****** Object:  StoredProcedure [dbo].[SpcCVAFluxoCaixa]    Script Date: 06/09/2015 09:17:52 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SpcCVAFluxoCaixa]') AND type in (N'P', N'PC'))
...
SET DATEFORMAT 'ymd';  
  ...
  exec SpcCVAFluxoCaixa_CARGA @dtInicial,@dt,@Previsoes,@SaldoInicial
...
--exec SpcCVAFluxoCaixa ' 2018-05-15','2018-05-31','N','N','N','N',0
--exec SpcCVAFluxoCaixa ' 2018-05-15','2018-05-31','N','N','N','C',0