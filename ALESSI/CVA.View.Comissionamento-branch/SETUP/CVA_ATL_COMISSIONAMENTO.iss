...
Source: "C:\Source\ALESSI\CVA.View.Comissionamento-branch\SETUP\MEF\ISSkin.dll"; DestDir: {app}; Flags: dontcopy
Source: "C:\Source\ALESSI\CVA.View.Comissionamento-branch\SETUP\MEF\Vista.cjstyles"; DestDir: {tmp}; Flags: dontcopy
Source: "C:\Source\ALESSI\CVA.View.Comissionamento-branch\CVA.View.Comissionamento\bin\x86\Debug\CVA.View.Comissionamento.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Source\ALESSI\CVA.View.Comissionamento-branch\CVA.View.Comissionamento\bin\x86\Debug\CVA.View.Comissionamento.exe.config"; DestDir: "{app}"; Flags: ignoreversion; AfterInstall: DeploySQL()
Source: "C:\Source\ALESSI\CVA.View.Comissionamento-branch\CVA.View.Comissionamento\bin\x86\Debug\Files\*"; DestDir: "{app}\Files"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
		...
		UnloadSkin();
    EndInstallEx('', false);
    UnloadDLL('C:\Source\ALESSI\CVA.View.Comissionamento-branch\SETUP\MEF\AddOnInstallAPI.dll');
end;
