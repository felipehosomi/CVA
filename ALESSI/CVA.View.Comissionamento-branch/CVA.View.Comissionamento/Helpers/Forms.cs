...
namespace CVA.View.Comissionamento.Helpers
{
    public class Forms
    {
        ...
        public static void LoadRegrForm(Form oForm)
        {
            ...
            Helpers.UserQueries.AssignFormattedSearch("REGRGROUP", Properties.Resources.REGRGROUP, View.RegraComissaoForm.Type, View.RegraComissaoForm.EditGroupCode);
            Helpers.UserQueries.AssignFormattedSearch("REGRCODIGOITEM", Properties.Resources.REGRCODIGOITEM, View.RegraComissaoForm.Type, View.RegraComissaoForm.EditCodigoItem);
            Helpers.UserQueries.AssignFormattedSearch("REGRCENTROCUSTO", Properties.Resources.REGRCENTROCUSTO, View.RegraComissaoForm.Type, View.RegraComissaoForm.EditCentroCusto);
            Helpers.UserQueries.AssignFormattedSearch("REGRCLIENTE", Properties.Resources.REGRCLIENTE, View.RegraComissaoForm.Type, View.RegraComissaoForm.EditCliente);
