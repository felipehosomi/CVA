...
[Setup]
AppName=SAP AddOn Hub
AppVerName=SAP AddOn Hub 1.0.0.67
...
[Files]
;Bibliotecas
Source: ..\CVA.AddOn.Hub\bin\Debug\CVA.AddOn.Hub.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.AddOn.Hub\bin\Debug\CVA.AddOn.Hub.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.AddOn.Hub\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPAddOnHub';
  PARTNER_ID = 'CVA';
