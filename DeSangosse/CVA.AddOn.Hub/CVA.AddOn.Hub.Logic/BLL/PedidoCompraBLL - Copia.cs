            ...
            try
            {
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ...
                        userTable.UserFields.Fields.Item("U_DocEntry").Value = table.GetValue("Chave Origem", i);
                        userTable.UserFields.Fields.Item("U_DocNum").Value = table.GetValue("DocNum", i);
