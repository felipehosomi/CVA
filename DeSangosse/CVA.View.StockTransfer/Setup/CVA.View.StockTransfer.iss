...
[Setup]
AppName=CVA - Transferência Estoque
AppVerName=CVA - Transferência Estoque 1.0.0.18
...
[Files]
;Bibliotecas
Source: ..\CVA.View.StockTransfer.AddOn\bin\Debug\CVA.View.StockTransfer.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.StockTransfer.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPStockTransfer';
  PARTNER_ID = 'CVA';
