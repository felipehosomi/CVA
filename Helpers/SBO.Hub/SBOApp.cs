    ...
    public class SBOApp
    {
       ...
       // public static TranslatorTool Translator { get; private set; }
        ...
        public static string TranslateToHana(string sql)
        {
            ...
            {
                sql = HanaTranslator.Translate(sql);
            }
            return sql;
        ...
        {
            Application.AppEvent += new SAPbouiCOM._IApplicationEvents_AppEventEventHandler(EventService.AppEvent);
            Application.FormDataEvent += new SAPbouiCOM._IApplicationEvents_FormDataEventEventHandler(EventService.FormDataEvent);
            Application.ItemEvent += new SAPbouiCOM._IApplicationEvents_ItemEventEventHandler(EventService.ItemEvent);
            Application.MenuEvent += new SAPbouiCOM._IApplicationEvents_MenuEventEventHandler(EventService.MenuEvent);
            Application.PrintEvent += new SAPbouiCOM._IApplicationEvents_PrintEventEventHandler(EventService.PrintEvent);
            Application.ProgressBarEvent += new SAPbouiCOM._IApplicationEvents_ProgressBarEventEventHandler(EventService.ProgressBarEvent);
            Application.ReportDataEvent += new SAPbouiCOM._IApplicationEvents_ReportDataEventEventHandler(EventService.ReportDataEvent);
            Application.RightClickEvent += new SAPbouiCOM._IApplicationEvents_RightClickEventEventHandler(EventService.RightClickEvent);
            Application.StatusBarEvent += new SAPbouiCOM._IApplicationEvents_StatusBarEventEventHandler(EventService.StatusBarEvent);
        }
        #endregion
