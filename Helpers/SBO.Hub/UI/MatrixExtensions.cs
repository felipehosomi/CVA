...
namespace SBO.Hub.UI
{
    ...
    {
        #region AddMatrixRow
        public static Matrix AddMatrixRow(this Matrix matrix, IDBDataSource dBDataSource, bool focusCell)
        {
        ...
        public static List<T> FillModelListFromMatrix<T>(this Matrix mtx)
        {
                ...
                foreach (PropertyInfo property in model.GetType().GetProperties())
                {
                    ...
                    foreach (Attribute attribute in property.GetCustomAttributes(true))
                    {
                        ...
                        if (hubModel != null)
                        {
                            ...
                            if (String.IsNullOrEmpty(hubModel.DataSourceFieldName))
                            {
                                hubModel.DataSourceFieldName = property.Name;
                            }
