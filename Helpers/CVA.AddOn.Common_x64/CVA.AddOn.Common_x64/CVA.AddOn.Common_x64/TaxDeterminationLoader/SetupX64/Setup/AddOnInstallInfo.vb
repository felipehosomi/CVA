...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            MyBase.New
            'INITIALIZATION CODE	...
            AddOnName = "Tax Determination Loader "
            PartnerName = "CVA"
            RestartNeeded = False
            ExeFile = "TaxDeterminationLoader.exe"
            DIFile = "Interop.SAPbobsCOM.dll"
            UIFile = "Interop.SAPbouiCOM.dll"
            B1WizardBaseFile = ""
            ExtraFiles = New String() {"DetermCodImposto_formImport.srf"}
            ExtraDirectories = New String() {"TaxDeterminationLoader\Resources\Forms"}
        End Sub
    End Class
End Namespace
