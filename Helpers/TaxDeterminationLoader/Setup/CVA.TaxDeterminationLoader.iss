...
OutputBaseFilename=TaxDeterminationLoaderSetup
Compression=lzma
...
Source: "..\bin\Debug\TaxDeterminationLoader.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Debug\Interop.SAPbobsCOM.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Debug\Interop.SAPbouiCOM.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Debug\TaxDeterminationLoader.exe.config"; DestDir: "{app}"; Flags: ignoreversion



Source: "..\bin\Debug\TaxDeterminationLoader.pdb"; DestDir: "{app}"; Flags: ignoreversion
...
[Code]
const
	ADDON_ID = 'Tax Determination Loader';
	PARTNER_ID = 'CVA'; 
...
begin
		...
		UnloadSkin();
    EndInstallEx('', false);
    UnloadDLL('..\MEF\AddOnInstallAPI.dll');  // instalação cancelada
end;
...
begin
  ...
  UnloadDLL('..\MEF\AddOnInstallAPI.dll');
end;