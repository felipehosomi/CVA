...
[Setup]
AppName=CVA - Transferência Filiais
AppVerName=CVA - Transferência Filiais 1.0.0.1
...
[Files]
;Bibliotecas
Source: ..\CVA.View.TransferenciaFiliais.AddOn\bin\Debug\CVA.View.TransferenciaFiliais.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.TransferenciaFiliais.AddOn\bin\Debug\CVA.View.TransferenciaFiliais.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.TransferenciaFiliais.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
...
const
  ADDON_ID   = 'CVAViewTransferenciaFiliais';
  PARTNER_ID = 'CVA';
