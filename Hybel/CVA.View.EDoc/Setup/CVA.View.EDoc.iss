...
[Setup]
AppName=SAP AddOn EDoc
AppVerName=SAP AddOn EDoc 1.0.0.3
...
[Files]
;Bibliotecas
Source: ..\CVA.View.EDoc.AddOn\bin\Debug\CVA.View.EDoc.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.EDoc.AddOn\bin\Debug\CVA.View.EDoc.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.EDoc.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.EDoc.AddOn\bin\Debug\Menu\*.xml; DestDir: {app}\Menu; Flags: ignoreversion
Source: ..\CVA.View.EDoc.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: ..\CVA.View.EDoc.AddOn\bin\Debug\DAO\Sproc\*.*; DestDir: {app}\DAO\Sproc; Flags: ignoreversion
