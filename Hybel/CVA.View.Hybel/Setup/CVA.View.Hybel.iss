...
[Setup]
AppName=SAP AddOn Hybel
AppVerName=SAP AddOn Hybel 1.0.0.53
...
[Files]
;Bibliotecas
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\CVA.View.Hybel.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\CVA.View.Hybel.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\Reports\*.rpt; DestDir: {app}\Reports; Flags: ignoreversion
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\Reports\*.xlsx; DestDir: {app}\Reports; Flags: ignoreversion
Source: ..\CVA.View.Hybel.AddOn\bin\Debug\ModelosEmail\*.html; DestDir: {app}\ModelosEmail; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPViewHybel';
  PARTNER_ID = 'CVA';
