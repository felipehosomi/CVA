...
[Setup]
AppName=SAP AddOn Comissionamento
AppVerName=SAP AddOn Comissionamento 1.0.0.8
...
[Files]
;Bibliotecas
Source: "..\CVA.View.Comissionamento.AddOn\bin\Debug\CVA.View.Comissionamento.AddOn.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.View.Comissionamento.AddOn\bin\Debug\CVA.View.Comissionamento.AddOn.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.View.Comissionamento.AddOn\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.View.Comissionamento.AddOn\bin\Debug\*.xml"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.View.Comissionamento.AddOn\bin\Debug\Files\*"; DestDir: "{app}\Files"; Flags: ignoreversion recursesubdirs createallsubdirs

[Code]

const
  ADDON_ID   = 'SAPViewComissao';
  PARTNER_ID = 'CVA';
