...
namespace CVA.View.Comissionamento.Views
{
    public class CalculoComissaoForm
    {
        ...
        public const string EditMetaInicial = "et_MetaI";
        public const string EditMetaFinal = "et_MetaF";
        public const string EditComissaoInicial = "et_ComI";
        public const string EditComissaoFinal = "et_ComF";
        ...
        public const string ColumnEditNumeroNF = "Col_21";
        public const string ColumnDataRecebimento = "Col_22";
        ...
        public const string ButtonRemover = "Item_0";
        ...
        public const string UserDatasourceUD_Col23 = "UD_27";
        public const string UserDatasourceUD_Col24 = "UD_28";
        public const string ud_PercentEquipe = "ud_PercE";
        public const string ud_ValorEquipe = "ud_VlrE";
        public const string ud_DSR = "ud_DSR";
        public const string ud_Total = "ud_Total";

        public static string FilePath = $"{AppDomain.CurrentDomain.BaseDirectory}\\Files\\Forms\\cva_calculo_comissao.srf";
    }
}
