IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'SP_CVA_SEF_0150')
	DROP PROCEDURE SP_CVA_SEF_0150
GO

-- exec SP_CVA_SEF_0150 1, '2018-01-01', '2018-31-01'
CREATE PROCEDURE SP_CVA_SEF_0150
(
	@Filial			INT,
	@DataDe			DATETIME,
	@DataAte		DATETIME
