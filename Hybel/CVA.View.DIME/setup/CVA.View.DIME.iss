...
[Setup]
AppName=SAP AddOn DIME
AppVerName=SAP AddOn DIME 1.0.0.13
...
[Files]
;Bibliotecas
Source: ..\CVA.View.DIME.AddOn\bin\Debug\CVA.View.DIME.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.DIME.AddOn\bin\Debug\CVA.View.DIME.AddOn.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.DIME.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.DIME.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.DIME.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: ..\CVA.View.DIME.AddOn\bin\Debug\Layout\*.*; DestDir: {app}\Layout; Flags: ignoreversion
