...
{
  [CompilerGenerated]
  [Guid("E48270A1-352E-4C53-9422-6EF624D36F7C")]
  [TypeIdentifier]
  [ComImport]
  public interface IItems : IEnumerable
  {
    ...
    Item Item([MarshalAs(UnmanagedType.Struct), In] object Index);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    Item Add([MarshalAs(UnmanagedType.BStr), In] string UID, [In] BoFormItemTypes Type);
  }
}
