...
{
  [CompilerGenerated]
  [Guid("21925973-F8AC-47F9-A3D0-298612AEB94E")]
  [TypeIdentifier]
  [ComImport]
  public interface IItemEvent
  {
    ...
    [DispId(8)]
    string ItemUID { [DispId(8), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  }
}
