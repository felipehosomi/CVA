...
{
  [CompilerGenerated]
  [Guid("DE680833-445E-4AF0-A7E3-377D5135268B")]
  [TypeIdentifier]
  [ComImport]
  public interface IFields : IEnumerable
  {
    [DispId(0)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [return: MarshalAs(UnmanagedType.Interface)]
    Field Item([MarshalAs(UnmanagedType.Struct), In] object Index);
  }
}
