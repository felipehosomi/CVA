    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Application.SBO_Application.StatusBar.SetText("Conexão do add-on: Menu Consolidator", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
