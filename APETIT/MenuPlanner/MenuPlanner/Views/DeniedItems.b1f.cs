...
{
    [FormAttribute("MenuPlanner.Views.DeniedItems", "Views/DeniedItems.b1f")]
    class DeniedItems : UserFormBase
    {
        ...
        private void OnCustomInitialize()
        {
            ...
            var dataSource = UIAPIRawForm.DataSources.DBDataSources.Item("@CVA_DNI1");
        ...
        private void etCardCode_ChooseFromListAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            ...
            var dbDataSource = UIAPIRawForm.DataSources.DBDataSources.Item("@CVA_ODNI");
        ...
        private void mtItems_ChooseFromListAfter(object sboObject, SBOItemEventArg pVal)
        {
            ...
            var dbDataSource = UIAPIRawForm.DataSources.DBDataSources.Item("@CVA_DNI1");
