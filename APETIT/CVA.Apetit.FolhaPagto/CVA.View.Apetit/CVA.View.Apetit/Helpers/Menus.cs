...
namespace CVA.View.Apetit.Helpers
{
    public class Menus
    {
        public static void Add(string parentId, string menuId, string description, int position, BoMenuType type, string imagePath = null)
        {
            MenuCreationParams oCreationPackage = (MenuCreationParams)B1Connection.Instance.Application.CreateObject(BoCreatableObjectType.cot_MenuCreationParams);
