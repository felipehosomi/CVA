...
Source: "..\CVA.AddOn.FiltroRegional\bin\Debug\CVA.AddOn.FiltroRegional.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.AddOn.FiltroRegional\bin\Debug\Interop.SAPbobsCOM.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.AddOn.FiltroRegional\bin\Debug\Interop.SAPbouiCOM.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.AddOn.FiltroRegional\bin\Debug\stdole.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\CVA.AddOn.FiltroRegional\bin\Debug\Assistente de criação de ofertas de compra.b1f"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Code]
const
	ADDON_ID = 'CVA.AddOn.FiltroRegional';
	PARTNER_ID = 'CVA'; 
