...
namespace CVA.View.Apetit.IntegracaoWMS.View
{
    public abstract class BaseForm
    {
        ...
        public void Application_FormDataEvent(Application Application, ref SAPbouiCOM.BusinessObjectInfo BusinessObjectInfo, out bool bubbleEvent)
        {
            var ret = true;
                    ...
                    if ((BusinessObjectInfo.EventType.Equals(BoEventTypes.et_FORM_DATA_UPDATE) || BusinessObjectInfo.EventType.Equals(BoEventTypes.et_FORM_DATA_ADD)))
                    {
                        ...
                        if (BusinessObjectInfo.BeforeAction)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    if (item.Key == "ALTERAR")
                                        oForm.Items.Item(item.Key).Enabled = item.Value["ALTERAR"];
                                }
            ...
            if (ret)
                FormDataEvent(Application, ref BusinessObjectInfo, out ret);
        ...
        public void Application_ItemEvent(Application Application, string FormUID, ref ItemEvent pVal, out bool bubbleEvent)
        {
            ItemEvent(Application, FormUID, ref pVal, out bubbleEvent);
        ...
        public string OpenMenu(string MenuItem, string FilePath, MenuEvent pVal)
        {
            try
            {
        ...
        private void CreateChooseFromList(Form oForm)
        {
        ...
        public string GetTableUID(string tableName)
        {
            ...
            {
                if (oMenu.SubMenus.Item(i).String.Contains(tableName))
