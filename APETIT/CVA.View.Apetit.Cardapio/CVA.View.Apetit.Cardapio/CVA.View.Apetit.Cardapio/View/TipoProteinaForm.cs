...
namespace CVA.View.Apetit.Cardapio.View
{
    public class TipoProteinaForm : BaseForm
    {
        ...
        public override void CreateUserFields()
        {
            ...
            //userFields.CreateIfNotExist("@" + TableName, TB_Familia, "ID Familia", 15, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None);
            //userFields.CreateIfNotExist("@" + TableName, TB_SubFamilia, "ID Sub-Familia", 15, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None);
