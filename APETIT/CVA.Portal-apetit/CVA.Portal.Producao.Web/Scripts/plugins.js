    ...
    var formElements = function() {
        ...
        var feDaterangepicker = function() {
            if ($(".daterange").length > 0)
                $(".daterange")
                    .daterangepicker({ format: "YYYY-MM-DD", startDate: "2013-01-01", endDate: "2013-12-31" });
        };
        // END Daterangepicker
        ...
        var feMasked = function() {
            if ($("input[class^='mask_']").length > 0) {
                ...
                $("input.mask_date").mask("9999-9999");
        ...
        var feiCheckbox = function() {
            if ($(".icheckbox").length > 0) {
                $(".icheckbox, .iradio")
                    .iCheck({ checkboxClass: "icheckbox_minimal-grey", radioClass: "iradio_minimal-grey" });
            }
        };
        // END iCheckbox
    ...
    var uiElements = function() {
        ...
        var uiDatatable = function() {
            ...
            if ($(".datatable_simple").length > 0) {
                $(".datatable_simple")
                    .dataTable({ "ordering": false, "info": false, "lengthChange": false, "searching": false });
                $(".datatable_simple")
                    .on("page.dt",
                        function() {
                            onresize(100);
        ...
        var uiSmartWizard = function() {
            ...
            if ($(".wizard").length > 0) {
                ...
                if ($("#wizard-validation").length > 0) {
                    ...
                    var validator = $("#wizard-validation")
                        .validate({
                            rules: {
                                login: {
                                    required: true,
                ...
                $("#new-event")
                    .on("click",
                        function() {
                            ...
                            if (et != "") {
                                $("#external-events")
                                    .prepend('<a class="list-group-item external-event">' + et + "</a>");
                                prepare_external_list();
                            }
                        });
