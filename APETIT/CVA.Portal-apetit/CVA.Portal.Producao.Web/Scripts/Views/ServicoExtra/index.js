...
document.getElementById("btnCheckItem").addEventListener("click", function (event) {
    var itemExists = "0";
    var client = $('#ClienteCode').val();

    //$.ajax(
    //{
    //    type: 'GET',
    //    url: '/ServicoExtra/checkItemServExtra?client=' + client,
    //    datatype: 'html',
    //    async: false,
    ...
    //    new PNotify({
    //        title: 'Alerta',
    //        text: "Para continuar, é necessário informar o item de serviço extra no contrato guarda-chuva do cliente.",
    //        type: 'error',
    //        styling: 'bootstrap3'
    //    });
            ...
            $.getJSON(
                ...
                function (data) {
                    ...
                    if (data.length === 0) {
                        ...
                        if (data.CardCode !== null && data.CardCode !== '') {

                            loadingOn();
                            $.getJSON(
                                "/ServicoExtra/CallGetInsumo?BPLId=" + bplId,
                                {},
                                function (data) {
...
function AddClick() {
    ...
    var txtInsumoDesc = $("#Add-InsumoCode option:selected").text();
...
function EditClick() {
    ...
    var txtInsumoDesc = $("#Edit-InsumoCode option:selected").text();
