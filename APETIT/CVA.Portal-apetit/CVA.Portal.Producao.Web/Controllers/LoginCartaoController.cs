...
{
    public class LoginCartaoController : Controller
    {
        ...
        public async Task<ActionResult> Login(UsuarioModel model)
        {
            try
            {
                string message = await api.PostAsync("LoginCartao", model);
                ...
                {
                    model = await api.GetAsync<UsuarioModel>("UsuarioCartao", model.NumeroCartao);
                }
                ...
                {
                    return RedirectToAction("ApontamentoOPMenu", "Producao");
                }
                else
                {
        ...
        public ActionResult Logout()
        {
            ...
            return RedirectToAction("Index", "LoginCartao");
        }
    }
}