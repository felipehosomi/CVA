...
namespace CVA.Portal.Producao.DAO
{
    public class SqlDAO : IDAO
    {
        ...
        public SqlDAO()
        {
            if (String.IsNullOrEmpty(ConnectionString))
            {
                ...
                ConnectionString = $"data source={server};initial catalog={Database};persist security info=True;user id={dbUser};password={dbPassword};";
            }
        }
