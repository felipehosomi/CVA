...
#define MyAppName "CVA.Core.CalculoFrete.AddOn"
#define MyAppVersion "1.0.0.04"
#define MyAppPublisher "CVA"
#define MyAppURL "http://www.cvaconsultoria.com.br"
#define MyAppExeName "CVA.Core.Cianet.AddOn.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{C02AECFC-8AB8-4272-B603-BD295BC8A609}}
AppName={#MyAppName}
...
[Files]
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\MEF\AddOnInstallAPI.dll"; Flags: dontcopy
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\MEF\ISSkin.dll"; DestDir: {app}; Flags: dontcopy
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\MEF\Vista.cjstyles"; DestDir: {tmp}; Flags: dontcopy

Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\stdole.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\office.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\Microsoft.Vbe.Interop.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\Microsoft.Office.Interop.Word.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\Interop.SAPbouiCOM.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\Interop.SAPbobsCOM.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\CVA.Core.Cianet.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\CVA.AddOn.Common.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\ConverterLib.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\office.xml"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\Microsoft.Office.Interop.Word.xml"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\CVA.Core.Cianet.AddOn.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\CVA.AddOn.Common.dll.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\CVA.Core.Cianet.AddOn.exe"; DestDir: "{app}"; Flags: ignoreversion




Source: "C:\Users\Marco Kurpel\Source\Cianet\CVA.Core.CalculoFrete\CVA.Core.Cianet.AddOn\bin\Debug\srfFiles\*"; DestDir: "{app}\srfFiles"; Flags: ignoreversion recursesubdirs createallsubdirs
