...
namespace CVA_RepConfig.Forms.Base
{
    public partial class EditarBase_UserControl : UserControl
    {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Confirmar atualização do registro?", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bas.COMP = tbCOMP.Text;
                    bas.UPD = DateTime.Parse(tbUPD.Text);
                    bas.PAS = tbPAS.Text;
                    bas.STU = int.Parse(cbSTU.SelectedValue.ToString());
                    bas.SRVR = tbSRVR.Text;
                    bas.UNAME = tbUNAME.Text;
                    bas.USE_TRU = int.Parse(cbUSE_TRU.SelectedValue.ToString());
                    bas.DB_SRVR = tbDB_SRVR.Text;
                    bas.DB_UNAME = tbDB_UNAME.Text;
                    bas.DB_PAS = tbDB_PAS.Text;
                    bas.DB_TYP = int.Parse(cbDB_TYP.SelectedValue.ToString());
        ...
        private void EditarBase_UserControl_Load(object sender, EventArgs e)
        {
            try
            {
