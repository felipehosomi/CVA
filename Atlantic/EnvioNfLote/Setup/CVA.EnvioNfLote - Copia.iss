...
[Setup]
AppName=Envio de NF em lote
AppVerName=Envio de NF em lote 1.0.0.10
...
[Files]
;Bibliotecas
Source: ..\EnvioNfLote\bin\Debug\EnvioNfLote.exe; DestDir: {app}; Flags: ignoreversion
Source: ..\EnvioNfLote\bin\Debug\EnvioNfLote.exe.config; DestDir: {app}; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'EnvioNFLoteAddOn';
  PARTNER_ID = 'CVA';
