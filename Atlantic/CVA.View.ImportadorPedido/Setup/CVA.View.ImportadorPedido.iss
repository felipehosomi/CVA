...
AppVerName=CVA - Importador Pedido Compra 2.0.0.10
...
[Files]
;Bibliotecas
Source: ..\CVA.View.ImportadorPedido\bin\Debug\CVA.View.ImportadorPedido.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.ImportadorPedido\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.ImportadorPedido\bin\Debug\*.config; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.ImportadorPedido\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.ImportadorPedido\bin\Debug\Files\*.srf; DestDir: {app}\Files; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPImpPurchaseOrder';
  PARTNER_ID = 'CVA';
