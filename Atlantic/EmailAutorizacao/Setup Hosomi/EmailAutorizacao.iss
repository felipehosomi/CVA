...
[Setup]
AppName=CVA - E-mail Autorização
AppVerName=CVA - E-mail Autorização 1.0.0.1
...
[Files]
;Bibliotecas
Source: ..\EmailAutorizacao\bin\Debug\EmailAutorizacao.exe; Flags: ignoreversion; DestDir: {app}
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPEmailAutorizacao';
  PARTNER_ID = 'CVA';
