...
#define MyAppName "SAP AddOn Envio de e-mail para autorização de documentos"
#define MyAppVersion "1.0.0.0"
#define MyAppPublisher "CVA"
#define MyAppURL "http://www.cvaconsultoria.com.br"
#define MyAppExeName "EmailAutorizacao.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{2B354D0A-1F80-451D-97D1-E9A80712429C}
AppName={#MyAppName}
...
OutputBaseFilename=EmailAutorizacaoSetup
Compression=lzma
...
Source: "C:\Source\Atlantic\EmailAutorizacao\EmailAutorizacao\bin\Debug\EmailAutorizacao.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Source\Atlantic\EmailAutorizacao\EmailAutorizacao\bin\Debug\EmailAutorizacao.exe.config"; DestDir: "{app}"; Flags: ignoreversion
