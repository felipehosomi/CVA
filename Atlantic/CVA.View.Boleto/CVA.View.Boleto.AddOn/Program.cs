...
namespace CVA.View.Boleto.AddOn
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var sboApp = new SBOApp(args[0], Application.StartupPath + "\\CVA.View.Boleto.dll");
            sboApp.InitializeApplication();

            EventFilterController.SetDefaultEvents();
            BLL.UserFieldsBLL.CreateUserFields();
            BLL.EventFilterBLL.SetDefaultEvents();
