...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            MyBase.New
            'INITIALIZATION CODE	...
            AddOnName = "SAP Addon Folha Pagamento"
            PartnerName = "CVA"
            RestartNeeded = False
            ExeFile = "CVA.View.FolhaPagamento.AddOn.exe"
            DIFile = "Interop.SAPbobsCOM.dll"
            UIFile = "Interop.SAPbouiCOM.dll"
            B1WizardBaseFile = ""
            ExtraFiles = New String() {"CVA.AddOn.Common.dll", "CVA.View.FolhaPagamento.dll", "Menu.xml", "f5001.xml"}
            ExtraDirectories = New String() {"", "", "", "srfFiles"}
        End Sub
    End Class
End Namespace
