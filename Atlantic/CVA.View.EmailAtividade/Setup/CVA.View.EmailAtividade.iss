...
[Setup]
AppName=SAP AddOn E-mail Atividade
AppVerName=SAP AddOn E-mail Atividade 1.0.0.6
...
[Files]
;Bibliotecas
Source: ..\CVA.View.EmailAtividade.AddOn\bin\Debug\CVA.View.EmailAtividade.AddOn.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\CVA.View.EmailAtividade.AddOn\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.EmailAtividade.AddOn\bin\Debug\*.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\CVA.View.EmailAtividade.AddOn\bin\Debug\srfFiles\*.srf; DestDir: {app}\srfFiles; Flags: ignoreversion
Source: C:\Program Files (x86)\SAP\SAP Business One\AddOnInstallAPI.dll; Flags: dontcopy

[Code]

const
  ADDON_ID   = 'SAPViewEmailAtividade';
  PARTNER_ID = 'CVA';
