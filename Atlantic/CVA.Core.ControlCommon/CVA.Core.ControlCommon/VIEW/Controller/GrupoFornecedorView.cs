...
{
    [Form(B1Forms.GrupoFornecedor, "CVA.Core.ControlCommon.VIEW.Form.EmptyFormPartial.srf")]
    public class GrupoFornecedorView : DocumentoView
    {
        public GrupoFornecedorView(SAPbouiCOM.Application application, RegistroBLL registroBLL, BLL.BaseReplicadora.GenericBLL genericBLL) : base(application, registroBLL, genericBLL)
        {
            IsIdentity = true;
